...
# ══════════════════════════════════════════════════════════════════
P_INTERP_SEQUEIRO = {
    # argila_max: (MB_lim, B_lim, M_lim, Ad_lim)  → acima = Alto
...
#  Índices: Muito Baixo=0, Baixo=1, Médio=2
# ══════════════════════════════════════════════════════════════════
...
#  K em mg/dm³ por Mehlich-1; corretiva total e gradual (kg K₂O/ha)
# ══════════════════════════════════════════════════════════════════
# CTC a pH 7 < 4,0 cmolc/dm³
K_INTERP_CTC_BAIXA = {
    # K_mg_max: (classe, corr_total, corr_grad)
    15:  ('Baixo',    50,  70),
    30:  ('Médio',    25,  60),
    40:  ('Adequado',  0,   0),
    9999:('Alto',      0,   0),
...
#  (prod_max_tha, N_cob_min, N_cob_max)
# ══════════════════════════════════════════════════════════════════
N_FAIXAS = [
    ( 6,  40,  80),
    ( 8,  40,  80),
...
N_BASE_KGHA = 20   # fixo na semeadura
...
# ══════════════════════════════════════════════════════════════════
#  CONVERSAO PARA FERTILIZANTE COMERCIAL
# ══════════════════════════════════════════════════════════════════
